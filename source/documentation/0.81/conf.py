...
project = u'Elemental'
copyright = u'2009-2013, Jack Poulson'
...
htmlhelp_basename = 'Elementaldoc'
...
man_pages = [
    ('index', 'elemental', u'Elemental Manual',
     [u'Jack Poulson'], 1)
]
