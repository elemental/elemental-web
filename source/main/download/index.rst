.. How to download and install Elemental
...
`Elemental 0.84 <http://libelemental.org/releases/0.84>`__, 
and the relevant tarball 
`is available here <http://libelemental.org/pub/releases/Elemental-0.84-p1.tgz>`__.
